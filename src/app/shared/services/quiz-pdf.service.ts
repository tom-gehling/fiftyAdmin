...
export class QuizPdfService {
     ...
     */
    private addAnswerSheet(doc: jsPDF, questionCount: number, bgColor: { r: number; g: number; b: number }, fontColor: { r: number; g: number; b: number }): void {
     ...
     */
    private addSectionHeader(doc: jsPDF, text: string, y: number, bgColor: { r: number; g: number; b: number }, fontColor: { r: number; g: number; b: number }): number {
        doc.setFillColor(bgColor.r, bgColor.g, bgColor.b);
     ...
     */
    private checkPageBreak(doc: jsPDF, y: number, needed: number, bgColor: { r: number; g: number; b: number }): number {
     ...
     */
    private addFooters(doc: jsPDF, bgColor: { r: number; g: number; b: number }, fontColor: { r: number; g: number; b: number }): void {
     ...
     */
    private addWrappedText(doc: jsPDF, text: string, y: number, fontSize: number, fontStyle: 'normal' | 'bold' | 'italic', color: { r: number; g: number; b: number }, align: 'left' | 'center' = 'left'): number {
