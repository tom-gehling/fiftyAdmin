...
export class WordListService {
  ...
  private words4$: Observable<string[]> = this.http
    .get<string[]>('/assets/games/words-4.json')
    .pipe(shareReplay(1));

  private words5$: Observable<string[]> = this.http
    .get<string[]>('/assets/games/words-5.json')
    .pipe(shareReplay(1));
