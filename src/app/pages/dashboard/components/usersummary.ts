...
export class UserSummaryWidget implements OnInit {
    ...
    private readonly greetings = ['Hi', 'Hey', 'Welcome back', "G'day", 'Good to see you', 'Hiya', 'Bonjour', 'Hola', 'Ciao', 'Olá'];
    ...
    async ngOnInit() {
        onAuthStateChanged(this.auth, async (user) => {
            ...
            const weeklyQuizzes = allQuizzes
                ...
                .map((q) => {
                    const date = q.deploymentDate instanceof Date ? q.deploymentDate : (q.deploymentDate as any).toDate();
                    return {
