    ...
    template: `
        <div class="card mb-8 p-4 fiftyBorder">
            ...
            <ng-template #chartBlock>
                ...
                <ng-template #noData>
                    <div class="text-center text-gray-500 dark:text-gray-400 flex items-center justify-center">No completed quizzes yet.</div>
                </ng-template>
            </ng-template>
        </div>
    `
...
export class UserQuizHistoryWidget implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.subscriptions.add(this.layoutService.configUpdate$.subscribe(() => this.initChart()));
