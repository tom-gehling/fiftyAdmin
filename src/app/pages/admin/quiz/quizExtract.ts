                    ...
                    <p-tabpanels class="flex-1 flex flex-col overflow-visible">
                        ...
                        <p-tabpanel value="0" class="flex flex-col gap-4 h-full overflow-visible">
                            ...
                            <div class="quill-wrapper border border-gray-300 dark:border-gray-600 rounded-md p-1 overflow-visible relative">
                                <quill-editor #quillEditor [(ngModel)]="inputText" [modules]="quillModules" theme="bubble" style="width: 100%; height: 300px" placeholder="Paste questions and answers here (Question[TAB]Answer)"></quill-editor>
                            </div>
                            <button pButton type="button" label="Import" class="p-button-raised w-fit" (click)="importTextQuestions()"></button>
                        </p-tabpanel>

                        <!-- Excel Tab -->
                        <p-tabpanel value="1" class="flex flex-col gap-4 h-full overflow-y-auto">
                            <h4 class="text-lg font-semibold">Import from Excel</h4>
                            <input type="file" accept=".xlsx,.xls" (change)="onExcelSelected($event)" class="border border-gray-300 rounded-xl p-2" />
                        </p-tabpanel>
