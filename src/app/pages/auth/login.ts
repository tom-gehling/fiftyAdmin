                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            <img src="/assets/logos/fiftyplus.png" alt="Fifty Admin Logo" class="mx-auto mb-4" style="width: 30vw; max-width: 200px; height: auto;" />
                        </div>
                  ...
                  Register
                        ...
                        <div>
                            ...
                            <div *ngIf="isRegisterMode" class="mb-6">
                                <label for="displayName" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Display Name</label>
                                <input pInputText id="displayName" type="text" placeholder="Your name (optional)" class="w-full" [(ngModel)]="displayName" />
                            </div>
                            ...
                            <div *ngIf="isRegisterMode" class="mb-4">
                                ...
                                <p-password id="confirmPassword1" [(ngModel)]="confirmPassword" placeholder="Confirm password" [toggleMask]="true" styleClass="mb-4" [fluid]="true" [feedback]="false"></p-password>
                            </div>
                            ...
                            <p-button [label]="isRegisterMode ? 'Create Account' : 'Sign In'" styleClass="w-full" [loading]="loading" (click)="onSubmit()"> </p-button>
