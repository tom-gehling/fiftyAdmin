    ...
    template: `
        <div class="flex flex-col gap-4 p-1">
            ...
            <div class="flex flex-col gap-1">
                ...
                <p-inputNumber [(ngModel)]="score" [min]="0" [showButtons]="true" placeholder="Enter score" (ngModelChange)="validateScore()"></p-inputNumber>
...
export class RetroQuizResultComponent implements OnInit {
    ...
    async save() {
        ...
        await this.quizResultsService.createRetroResult(this.quizId, user.uid, this.score, this.totalQuestions, this.taggedUsers);
